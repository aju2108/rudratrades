			...
			<div class="col-xs-12">
					...
					<div class="row">
						<div class="col-xs-4">
							...
							<span style="float: left; margin-top: 27px;"> <strong>
									State Code : </strong>${users.statecode}<br> <strong> GSTIN : </strong>${users.gstin}
							</span>
						</div>
						...
						<div class="col-xs-8">
							...
							<span class="owner-title">${users.company}</span><br> <span
								style="text-align: center; float: left; margin-left: -40px;">
								<strong>M.No : </strong>${users.phone1}, ${users.phone2}<br> <strong>
									Email : </strong>${users.emailaddress}<br> 
									${users.address}
							</span>
						</div>
					</div>
				...
				<div class="row">
					...
					<div class="col-xs-6 text-right">
						...
						<strong>Vehical No : </strong>HR46B1595<br>
					</div>
				</div>
			</div>
		</div>
					...
					<div class="table-responsive padding0 margin0">
						<table class="table table-condensed margin0 bottomborder">
							<tbody>
								...
								<tr>
									<td class="text-left bottomborder"><strong>Net Amt</strong></td>
